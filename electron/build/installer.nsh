...
!macro customWelcomePage
  ...
  Function InstallerBuildFrame
    ...
    !insertmacro InstallerCreateLabel $0 244u 10u 40u 11u "${VERSION}" $InstallerSmallFont ${INSTALLER_SHADE} ${INSTALLER_LIGHT}
  ...
  Function InstallerBuildCompactFrame
    ...
    !insertmacro InstallerCreateLabel $0 16u 23u 150u 9u "安装程序 · ${VERSION}" $InstallerSmallFont ${INSTALLER_SHADE} ${INSTALLER_LIGHT}
...
!macro customPageAfterChangeDir
  ...
  Function InstallerInstallFilesCreate
    ...
    !insertmacro InstallerCreateProgressLabel "安装程序 · ${VERSION}" 25 ${INSTALLER_SHADE} ${INSTALLER_LIGHT} $InstallerSmallFont
